...
export default function AllComics () {
    ...
    return (
        <div className="container-more_info">
           ...
           <div className="container-more_info-header">
            ...
            <div className="comics_section">

                <div className="comics_section-comic_example">
                    {comicsDataForExample && characterName &&
                        <RandomComicCard data={comicsDataForExample} characterName={characterName} />
                    }
                </div>

                <div className="comics_section-comics_list">
                    <div className="comics_section-comics_list-main_cards">
                        {comicsData && 
                            comicsData.map((element, i) => {
                                return (
                                    <AllComicsCards data={element} key={`${element.id}_${i}`}/>
                                );
                            })
                        }
                    </div>

                    <div className="comics_section-comics_list-pagination">
                        <div className="comics_section-comics_list-pagination_2">
                            <Pagination offsetNumber={offsetNumber} setOffsetNumber={setOffsetNumber} total={total} />
                        </div>
                    </div>
